    ...
    implements Closeable
{
  ...
  /**
   * Create an BitbucketClient. If any of the passed in variables are null we will query System Properties and
   * Environment Variables, in order, to search for values that may be set in a devops/CI fashion. The only difference
   * is the `overrides` which gets merged, but takes precedence, with those System Properties and Environment Variables
   * found.
   *
  ...
  /**
   * Query System Properties and Environment Variables for overrides and merge the potentially passed in overrides with
   * those.
   *
  ...
  public static class Builder
  {
    ...
    /**
     * Optional credentials to use for authentication. Must take the form of `username:password` or its base64 encoded
     * version.
     *
